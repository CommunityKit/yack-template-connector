...
//             url = `${ROOT_URL}/t/${threadId}.json?page=${currentPage}`;
...
//                 let newComment = populateComment(comment, options, ROOT_URL);
...
//             url = `${ROOT_URL}/posts/${commentQuery.metadata.reactionId}.json`;
//             // formData = {
...
//                 const newComment = populateComment(data.post, options, ROOT_URL);
...
//             const newComment = populateComment(data, options, ROOT_URL);
//             if(parentCommentQuery !== null){
//                 newComment.parentCommentId = parentCommentQuery.id;
//             }
...
//             const url = `${ROOT_URL}/posts/${commentQuery.metadata.reactionId}.json`;
...
//             let url = `${ROOT_URL}/posts/${commentQuery.metadata.reactionId}.json`; // only using first element so don't need pagination
...
//             url = `${ROOT_URL}/t/${commentQuery.metadata.reactionId}/bookmark.json`
